...
export const setupMonaco = (monaco: Monaco) => {
  ...
  monaco.editor.defineTheme(YANTRA_THEME_MAP.dark, {
    ...
    inherit: true,
    rules: [
      { token: 'comment', foreground: '5B6475', fontStyle: 'italic' },
      { token: 'string', foreground: 'A7D9AE' },
      { token: 'number', foreground: 'E8B585' },
      { token: 'keyword', foreground: 'AAB4FF' },
      { token: 'keyword.control', foreground: 'AAB4FF' },
      { token: 'function', foreground: '84B0FF' },
      { token: 'function.declaration', foreground: '84B0FF' },
      { token: 'entity.name.function', foreground: '84B0FF' },
      { token: 'identifier', foreground: 'E8EDF8' },
      { token: 'variable', foreground: 'E8EDF8' },
      { token: 'variable.predefined', foreground: 'E8EDF8' },
      { token: 'type.identifier', foreground: 'D6DEEE' },
      { token: 'delimiter', foreground: 'CAD3E7' },
    ],
    colors: {
      'editor.background': '#04070D',
      'editor.foreground': '#E8EDF8',
      'editor.lineHighlightBackground': '#7382F614',
      'editor.lineHighlightBorder': '#00000000',
      'editorCursor.foreground': '#7382F6',
      'editorCursor.background': '#04070D',
      'editorLineNumber.foreground': '#566175',
      'editorLineNumber.activeForeground': '#C7D0FF',
      'editor.selectionBackground': '#7382F638',
      'editor.selectionHighlightBackground': '#7382F624',
      'editor.inactiveSelectionBackground': '#19213188',
      'editor.findMatchBackground': '#192435',
      'editor.wordHighlightBackground': '#7382F618',
      'editorIndentGuide.background1': '#192131',
      'editorIndentGuide.activeBackground1': '#44506B',
      'editorBracketMatch.background': '#141B2800',
      'editorBracketMatch.border': '#44506B',
      'editorGutter.background': '#04070D',
      'editorWidget.background': '#0B1018',
      'editorWidget.border': '#263146',
      'editorSuggestWidget.background': '#0B1018',
      'editorSuggestWidget.border': '#263146',
      'editorSuggestWidget.selectedBackground': '#101722',
      'editorHoverWidget.background': '#0B1018',
      'editorHoverWidget.border': '#263146',
      'scrollbarSlider.background': '#192131CC',
      'scrollbarSlider.hoverBackground': '#44506BCC',
      'scrollbarSlider.activeBackground': '#7382F6AA',
      'focusBorder': '#44506B',
    },
  });
